      ...
      <div className='py-32 bg-black text-white'>
        <div className='container mx-auto px-6 md:px-12'>
          <div className='grid lg:grid-cols-2 gap-20'>
            <div>
              <SectionHeading
                title={t.tech.dev_title}
                subtitle={t.tech.dev_subtitle}
                dark
              />
              ...
              <Button
                variant='outline'
                className='border-zinc-700 text-white hover:bg-white hover:text-black hover:border-white'
              >
                {t.tech.dev_cta}
              </Button>
            </div>
            <div className='bg-zinc-900 border border-zinc-800 p-8 font-mono text-sm text-zinc-400 rounded-lg shadow-2xl overflow-x-auto'>
              ...
              <p>
                <span className='text-white'>$</span> npm install @primex/sdk
              </p>
              <br />
              <p className='opacity-50'>// Initialize Client</p>
              <p>
                import <span className='text-white'>{`{ PrimeX }`}</span> from
                '@primex/sdk';
              </p>
              <p>
                const client = new PrimeX({`{`} key:{' '}
                <span className='text-white'>ENV_KEY</span> {`}`});
              </p>
              <br />
              ...
              <p className='pl-4'>
                name:{' '}
                <span className='text-white'>"Private Credit Fund I"</span>,
              </p>
              <p className='pl-4'>
                symbol: <span className='text-white'>"PCF1"</span>,
              </p>
              <p className='pl-4'>
                supply: <span className='text-white'>50000000</span>
              </p>
              <p>{`}`});</p>
            </div>
          </div>
