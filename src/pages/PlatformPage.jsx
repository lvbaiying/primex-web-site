    ...
    <div className='pt-32 pb-20 bg-white'>
      <div className='container mx-auto px-6 md:px-12'>
        <div className='grid md:grid-cols-2 gap-16 mb-24'>
          <FadeIn>
            <h1 className='text-6xl font-light tracking-tighter mb-8 whitespace-pre-line'>
            ...
            <ul className='space-y-4 mb-8'>
              ...
              <li className='flex items-center gap-3'>
                <Check className='text-black' />{' '}
                <span>Bank Custody Integration</span>
              </li>
            </ul>
          </FadeIn>
          <FadeIn delay={200}>
          ...
          {[
            ...
            >
              <div className='h-full bg-zinc-50 p-8 border border-zinc-200 hover:shadow-xl hover:-translate-y-2 transition-all duration-300'>
                <div className='mb-6 p-4 bg-white border border-zinc-100 rounded-lg w-fit'>
                  {m.icon}
                </div>
