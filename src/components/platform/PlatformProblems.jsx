  ...
  return (
    <div className='py-24 border-y border-zinc-100 bg-zinc-50'>
      <div className='container mx-auto px-6 md:px-12'>
        <SectionHeading
          title={t('platform.problems_title')}
          subtitle={t('platform.problems_subtitle')}
        />
        <div className='grid md:grid-cols-3 gap-12'>
          <FadeIn delay={100}>
            <div className='flex flex-col gap-4'>
              <div className='p-4 bg-white border border-zinc-200 rounded-lg w-fit'>
                <Clock
