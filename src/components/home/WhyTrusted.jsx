        ...
        {[
          ...
          >
            <div className='text-center h-full group p-6 rounded-lg hover:bg-zinc-50 transition-colors'>
              <div
                className={`w-20 h-20 mx-auto bg-zinc-100 rounded-full flex items-center justify-center mb-8 border border-zinc-200 group-hover:border-black transition-all duration-500`}
              >
