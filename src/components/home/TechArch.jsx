      ...
      <div className='container mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-24 items-center'>
        <FadeIn>
          <div className='relative p-12 border border-zinc-100 bg-zinc-50 rounded-full aspect-square flex items-center justify-center max-w-md mx-auto'>
            <div
              className='absolute inset-0 border border-dashed border-zinc-200 rounded-full animate-spin-slow'
            ...
            {[0, 72, 144, 216, 288].map((deg, i) => {
              ...
              return (
                <div
                  key={i}
                  className='absolute w-16 h-16 bg-white border border-zinc-200 rounded-full flex items-center justify-center text-[10px] font-bold shadow-sm'
                  style={{
                    top: `${y}%`,
                    left: `${x}%`,
