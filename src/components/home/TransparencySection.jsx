  ...
  return (
    <div className='py-32 bg-zinc-50 border-t border-zinc-200'>
      <div className='container mx-auto px-6 md:px-12'>
        <SectionHeading
          title={t('transparency_home.title')}
          subtitle={t('transparency_home.subtitle')}
          align='center'
        />
          ...
          {[
            {
              ...
              title: t('transparency_home.t1_title'),
              desc: t('transparency_home.t1_desc'),
            },
            {
              icon: (
                <ShieldCheck
              ...
              title: t('transparency_home.t2_title'),
              desc: t('transparency_home.t2_desc'),
            },
            {
              icon: (
                <Users
              ...
              title: t('transparency_home.t3_title'),
              desc: t('transparency_home.t3_desc'),
            },
          ].map((item, i) => (
            <FadeIn
              key={i}
            ...
            >
              <div className='flex flex-col items-center text-center group cursor-pointer'>
                ...
                <p className='text-zinc-500 text-sm leading-relaxed max-w-xs font-light mb-6'>
                  {item.desc}
                </p>
