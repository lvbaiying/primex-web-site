...
const EcosystemCollaboration = () => {
  ...
  const partners = [
    {
      cat: t('ecosystem.custody'),
      desc: t('ecosystem.custody_desc'),
      logos: ['Fireblocks', 'Anchorage', 'BitGo'],
    },
    {
      cat: t('ecosystem.fund_admin'),
      desc: t('ecosystem.fund_admin_desc'),
      logos: ['Apex', 'Trident', 'Gen II'],
    },
    {
      cat: t('ecosystem.identity'),
      desc: t('ecosystem.identity_desc'),
      logos: ['Sumsub', 'Onfido', 'Fractal'],
    },
    {
      cat: t('ecosystem.data'),
      desc: t('ecosystem.data_desc'),
      logos: ['Chainlink', 'Pyth', 'DIA'],
    },
    {
      cat: t('ecosystem.liquidity'),
      desc: t('ecosystem.liquidity_desc'),
      logos: ['Wintermute', 'GSR', 'Keyrock'],
    },
  ];
              ...
              <div className='bg-white p-6 border border-zinc-200 rounded-lg hover:border-black hover:shadow-lg transition-all h-full flex flex-col'>
                ...
                <div className='mt-auto space-y-3 border-t border-zinc-100 pt-4'>
                  {p.logos.map((logo, idx) => (
                    <div
                      key={idx}
                      className='flex items-center gap-2 font-serif font-bold text-zinc-700 text-sm'
                    >
