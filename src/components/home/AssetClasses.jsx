...
const AssetClasses = () => {
  ...
  return (
  <div className="py-32 bg-white" id="assets">
    <div className="container mx-auto px-6 md:px-12">
      <SectionHeading title={t('assets_home.title')} subtitle={t('assets_home.subtitle')} />
      ...
      <div className="grid md:grid-cols-3 gap-px bg-zinc-200 border border-zinc-200">
        {[
          ...
          { 
            ...
            icon: <Coins size={40} strokeWidth={1} />, 
          ...
          <FadeIn key={i} delay={i * 150}>
            <div className="group bg-white p-12 h-full hover:bg-zinc-50 transition-colors flex flex-col justify-between min-h-[450px]">
              <div>
                <div className="mb-12 text-zinc-400 group-hover:text-black transition-colors">{item.icon}</div>
                <h3 className="text-3xl font-light mb-6 tracking-tight">{item.title}</h3>
                <p className="text-zinc-500 leading-relaxed mb-8 font-light">{item.desc}</p>
