  ...
  <footer className="bg-black text-white py-24 border-t border-zinc-800">
    <div className="container mx-auto px-6 md:px-12">
      <div className="grid md:grid-cols-4 gap-12">
        ...
        <div>
          <h5 className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500 mb-8">{t.footer.connect}</h5>
        ...
        <div>
          <h5 className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500 mb-8">{t.footer.legal}</h5>
          <ul className="space-y-4 text-sm text-zinc-400">
