      ...
      <FadeIn>
        <div className="flex flex-col md:flex-row justify-center gap-8 mt-12">
           <div className="p-8 border border-zinc-200 rounded-lg text-center max-w-sm">
              ...
              <p className="text-zinc-500">Certified security controls and data privacy practices.</p>
           </div>
           <div className="p-8 border border-zinc-200 rounded-lg text-center max-w-sm">
              <h3 className="text-xl font-bold mb-4">ISO 27001</h3>
              <p className="text-zinc-500">International standard for information security management.</p>
           </div>
        </div>
      </FadeIn>
    </div>
