...
const StatItem = ({ stat }) => {
  ...
  return (
    <div className="text-left group" ref={ref}>
...
const StatsSection = () => {
  ...
  const stats = [
    { val: t('stats.s1_val'), prefix: t('stats.s1_pre'), suffix: t('stats.s1_suf'), label: t('stats.s1_label') },
    { val: t('stats.s2_val'), prefix: t('stats.s2_pre'), suffix: t('stats.s2_suf'), label: t('stats.s2_label') },
    { val: t('stats.s3_val'), prefix: t('stats.s3_pre'), suffix: t('stats.s3_suf'), label: t('stats.s3_label') },
    { val: t('stats.s4_val'), prefix: t('stats.s4_pre'), suffix: t('stats.s4_suf'), label: t('stats.s4_label') },
  ];
